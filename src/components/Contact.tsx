...
const Contact = () => {
  return (
    <section className="py-20 bg-gradient-to-br from-primary/5 via-background to-tech/5">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="shadow-elegant">
              ...
              <CardContent className="space-y-6">
                <div className="space-y-4">
                  <Button className="w-full justify-start text-left h-auto p-4 shadow-card" size="lg">
                  ...
                  <Button variant="outline" className="w-full justify-start text-left h-auto p-4 shadow-card" size="lg">
                    <div className="flex items-center gap-4 w-full">
                      <div className="p-2 bg-primary/10 rounded-lg">
